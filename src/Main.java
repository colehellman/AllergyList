...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (choice.matches("(?i:f(ile)?)")) {
            ...
            while (true) {
                System.out.println("Enter each ingredient to add to checklist (exit when finished or to quit):");
        ...
        if (dangerous) {
            System.out.println("This is not a safe product to use.");
        } else {
            System.out.println("This is a safe product to use.");
        }
    }
